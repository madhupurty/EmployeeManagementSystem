 ...
 * Extracts the token from Authorization header and sets Spring Security context.
 */
@Component
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void setAuthenticationInContext(UserDetails userDetails, HttpServletRequest request) {
        ...
        logger.debug("Set authentication in SecurityContext for user: {}", userDetails.getUsername());
    }
